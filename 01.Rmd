...
Food is being wasted in all stages of a Food Supply Cycle -  Production, Processing and Distribution, Retail and Consumer Usage. 

Let's see how we can reduce Food Wastage at stage:

-> Help Consumers Shop Wisely at Grocery Store 

-> Pantry/Refrigerator Alert : RFID – use of technology to track inventory of perishable and non-perishable food supply, including quantity and expiry dates and provide alerts 

-> Suggest recipes for Consumers based on available ingredients 

-> Create neural network for collection of food from consumers, retailers, producers and distributors using real time data
