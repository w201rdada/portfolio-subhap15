...
2.	 On the Pantry/Refrigerator door, an iOT device needs to be installed to scan, register and watermark (through simple color coding / RFID labels) an item. 
...
6.	 Using Machine learning technique, the App will provide personalized suggestion of recipes to consumers taking into account ingredients available and about to expire, your cuisine preferences, allergies etc. In case of restaurants, the App would inspire the Chef to develop Chef's specials for the day.

#### Items you may want to buy…
7.	 This App will generate smart shopping list for the items you’re running out so you can re-stock your inventory (what you need to buy, when you need to buy). This feature can be extended further and orders can be placed to deliver groceries. For restaurants especially, Smart Inventory tracking and reducing wastage helps minimize loses and increases profitability.
