...
While this technology is currently available for commercial purposes, a lot of work needs to be done to scale it down for consumer use. Even though the RFID labels will be designed to emit low-level frequency signal, its impact on food safety is yet to be studied.
To motivate people, need to build targeted awareness (online) campaigns & focus groups, partner with grocery chains to integrate their digital coupons with native app. With awareness campaigns and funding through partnership with consumer appliance manufacturers, these technologies can be made available to consumers.  
